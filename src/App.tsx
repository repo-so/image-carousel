...
function App() {
  ...
  return (
    ...
    <div className="flex justify-between items-center w-full h-dvh px-4 gap-5">
      <div className='bg-gray-700 text-center rounded-4xl  border-white/25  border h-[94%]'>
      ...
      <div className="flex justify-center items-center bg-[#272727] w-[96%] h-[94%]  rounded-3xl border-white/25 border">
        <Carousel />
      </div>
